...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 3. Active Nav Link Detection (if not already set server-side)
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
      // In Laravel mode, if it's posting to server, let normal post work if no JS intercept or handle graceful client validation
      let isValid = true;
